...
class paypal_lib
{
    ...
    function __construct()
    {
        ...
        $records = $this->CI->db->get('system_settings')->result_array();
        if (!empty($records)) {
        ...
        $this->paypal_url   = ($sanbox_live == 'sandbox') ? 'https://www.sandbox.paypal.com/cgi-bin/webscr' : 'https://www.paypal.com/cgi-bin/webscr';
        $this->last_error   = '';
        $this->ipn_response = '';
