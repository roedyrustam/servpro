	...
	<div class="content container-fluid">
		<div class="row">
			<div class="col-xl-8 offset-xl-2">
				...
				<div class="card">
					<div class="card-body">
						<form id="about_us" class="form-horizontal"  method="POST" enctype="multipart/form-data" id="
						">
						<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>"/>
	                        ...
	                        <div class="form-group">
							 ...
							 <div class="form-group">
							    ...
							    <textarea class='form-control content-textarea' id='ck_editor_textarea_id2' rows='6' name='page_content' required><?php echo ($pages[0]->page_content) ? $pages[0]->page_content:''; ?></textarea>
