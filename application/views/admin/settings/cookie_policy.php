	...
	<div class="content container-fluid">
		<div class="row">
			<div class="col-xl-8 offset-xl-2">
				...
				<div class="card">
					<div class="card-body">
						<form id="cookie_policy" class="form-horizontal"  method="POST" enctype="multipart/form-data" >
						<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>"/>
							<div class="form-group">
								
                                <label>Page Title </label>
                                <input type="text" style="text-transform: capitalize;" class="form-control" name="page_title" value="<?php echo ($pages[0]->page_title)?$pages[0]->page_title:''; ?>" required>
	                        </div>
	                        <div class="form-group">
