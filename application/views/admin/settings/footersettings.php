				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="form-group">
										    ...
										    <textarea class='form-control content-textarea ckeditor' id='ck_editor_textarea_id1' rows='6' name='copyright_title'>
										...
										<?php 
										if(!empty($copyright_result['link'])&& $copyright_result['link'] != 'null') {
										 $linked = json_decode($copyright_result['link']); 
											...
											<?php $i++;} }  else {?> 
												 <div class="row align-items-center">
													...
													<div class="col-lg-8 col-12">
														<input type="text" class="form-control" placeholder="Link with http:// Or https://" name="link1[]" value="<?php echo base_url();?>termscondition">
													</div>
													<div class="col-lg-1 col-12">
														<a href="#" class="btn btn-sm bg-danger-light delete_copyright" data-id="">
															<i class="far fa-trash-alt "></i> 
														</a>
													</div>
												</div>
												<div class="row align-items-center mt-4">
													<div class="col-lg-3 col-12">
														<input type="text" class="form-control" placeholder="Label" name="label1[]" value="Privacy Policy">
													</div>
													<div class="col-lg-8 col-12">
														<input type="text" class="form-control" placeholder="Link with http:// Or https://" name="link1[]" value="<?php echo base_url();?>privacypolicy">
													</div>
													<div class="col-lg-1 col-12">
														<a href="#" class="btn btn-sm bg-danger-light delete_copyright" data-id="">
															<i class="far fa-trash-alt "></i> 
											...
											<div class="form-group">
												<a class="btn  btn-success addnewlinks"><i class="<i class="fas fa-plus mr-1"></i>Add New</a>
											</div>
							...
							<form class="form-horizontal mt-5" id="banner_settings" action="<?php echo base_url('admin/Footer_submenu/category_widget'); ?>"  method="POST" enctype="multipart/form-data" >
							 	<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
								<div class="card">
									<div class="card-header">
										<div class="card-heads">
						...
						<form class="form-horizontal" id="banner_settings" action="<?php echo base_url('admin/Footer_submenu/link_widget'); ?>"  method="POST" enctype="multipart/form-data" >
									...
									<div class="card-body">
										...
										<?php } }  else { ?>
											<div class="form-group links-cont">
											    <div class="row align-items-center">
											        <div class="col-lg-3 col-12">
											            <input type="text" class="form-control" name="label[]" id="label" placeholder="Title" value="Service Request">
											        </div>
											        <div class="col-lg-8 col-12">
											            <input type="text" class="form-control" name="link[]" id="link" placeholder="Links" value="<?php echo base_url();?>request">
											        </div>
											        <div class="col-lg-1 col-12">
											    ...
											    <div class="row align-items-center mt-4">
											        <div class="col-lg-3 col-12">
											            <input type="text" class="form-control" name="label[]" id="label" placeholder="Title" value="Book Service">
											        </div>
											        <div class="col-lg-8 col-12">
											            <input type="text" class="form-control" name="link[]" id="link" placeholder="Links" value="<?php echo base_url();?>service">
											        </div>
											        <div class="col-lg-1 col-12">
											            <a href="#" class="btn btn-sm bg-danger-light  delete_menu">
											                <i class="far fa-trash-alt "></i> 
											    ...
											    <div class="row align-items-center mt-4">
											        <div class="col-lg-3 col-12">
											            <input type="text" class="form-control" name="label[]" id="label" placeholder="Title" value="Help">
											        </div>
											        <div class="col-lg-8 col-12">
											            <input type="text" class="form-control" name="link[]" id="link" placeholder="Links" value="<?php echo base_url();?>help">
											        </div>
											        <div class="col-lg-1 col-12">
											            <a href="#" class="btn btn-sm bg-danger-light  delete_menu">
											                <i class="far fa-trash-alt "></i> 
											    ...
											    <div class="row align-items-center mt-4">
											        <div class="col-lg-3 col-12">
											            <input type="text" class="form-control" name="label[]" id="label" placeholder="Title" value="Cookie Policy">
											        </div>
											        <div class="col-lg-8 col-12">
											            <input type="text" class="form-control" name="link[]" id="link" placeholder="Links" value="<?php echo base_url();?>cookie-policy">
											        </div>
											        <div class="col-lg-1 col-12">
											            <a href="#" class="btn btn-sm bg-danger-light  delete_menu">
											                <i class="far fa-trash-alt "></i> 
							...
							<form class="form-horizontal mt-5" id="banner_settings" action="<?php echo base_url('admin/Footer_submenu/social_widget'); ?>"  method="POST" enctype="multipart/form-data" >
							 	<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
								<div class="card">
									<div class="card-header">
										<div class="card-heads">
									...
									<div class="card-body">
										...
										<div class="setings" id="link_<?php  ?>">
