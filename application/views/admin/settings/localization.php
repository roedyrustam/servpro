<?php  
$query = $this->db->get('currency')->result_array();
...
$time_zone = $this->db->get_where('system_settings',array('key' => 'time_zone'))->row()->value;
							...
							<div class="card-body">
								<div class="form-group">
									...
									<select class="form-control select2" name="time_zone" id="time_zone">
										<option value="India" <?php if($time_zone=='India'){echo 'selected';
                                                }?>>(UTC+05:30) India</option>
										<option value="USA"<?php if($time_zone=='USA'){echo 'selected';
                                                }?>>(GMT-5) USA</option>
										<option value="Australia"<?php if($time_zone=='Australia'){echo 'selected';
                                                }?>>(UTC +10:30) Australia</option>
										<option value="South America"<?php if($time_zone=='South America'){echo 'selected';
                                                }?>>(UTC -5) South America</option>
										<option value="Asia"<?php if($time_zone=='Asia'){echo 'selected';
                                                }?>>(UTC +4) Asia</option>
										<option value="North America Atlantic"<?php if($time_zone=='North America Atlantic'){echo 'selected';
                                                }?>>(UTC -3) North America Atlantic</option>
										<option value="South America"<?php if($time_zone=='South America'){echo 'selected';
                                                }?>>(UTC -4) South America</option>
										<option value="Pacific"<?php if($time_zone=='Pacific'){echo 'selected';
                                                }?>>(UTC -12) Pacific</option>
										<option value="Military"<?php if($time_zone=='Military'){echo 'selected';
                                                }?>>(UTC +2) Military</option>
										<option value="Europe"<?php if($time_zone=='Europe'){echo 'selected';
                                                }?>>(UTC +1) Europe</option>
									</select>
								</div>
								<div class="form-group">
									...
									<select class="form-control select2" name="date_format" id="date_format">
										<option value="Y/m/d" <?php if($date_format=='Y/m/d'){echo 'selected';
                                                }?>><?php echo date('Y/m/d'); ?></option>
										<option value="d.m.Y" <?php if($date_format=='d.m.Y'){echo 'selected';
                                                }?>><?php echo date('d.m.Y'); ?></option>
										<option value="d-m-Y" <?php if($date_format=='d-m-Y'){echo 'selected';
                                                }?>><?php echo date('d-m-Y'); ?></option>
                                        <option value="m/d/Y" <?php if($date_format=='m/d/Y'){echo 'selected';
								...
								<div class="form-group">
									...
									<select class="form-control select2"  name="time_format" id="time_format">
										<option <?php if($time_format=='12 Hours'){echo 'selected';
                                                }?>>12 Hours</option>
										<option <?php if($time_format=='24 Hours'){echo 'selected';
                                                }?>>24 Hours</option>
									</select>
								</div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="currency_symbol" id="currency_symbol" readonly="" value="<?php echo $cuurency_sym?$cuurency_sym:'';?>">
								</div>
