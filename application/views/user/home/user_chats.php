                    ...
                    <div class="col-lg-12">
                        <div class="iamusersec">
                            ...
                            <div class="iamuserstats owl-carousel owl-theme">
                                ...
                                <a class="active" href="#" title=""><i class="flaticon-thumb-up"></i>Chats</a>
                                <a href="#" title=""><i class="flaticon-thumb-up"></i>Reviews</a>
                            </div>
                                    </div>
                                </div>
...
<section>
   <div class="block gray mt-3 chat-history-blk">
      <div class="container">
                ...
                <div class="col-md-8 col-xl-8 chat">
                    <div class="card">
                        <div class="card-header msg_head">
                            ...
                            <span id="action_menu_btn"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></span>
                            <div class="action_menu">
                                <ul>
                                    <li><i class="fa fa-eraser" aria-hidden="true"></i> clear chat</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card-footer">
                            <div class="input-group">
                                ...
                                <textarea name="" class="form-control type_msg mh-auto" placeholder="Type your message..."></textarea>
                                <div class="input-group-append">
                                    <span class="input-group-text send_btn"><i class="fa fa-paper-plane" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
