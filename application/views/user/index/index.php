	...
	<div class="inner-banner">
		<div class="banner-left">
			...
			<div class="header-search">
					...
					<a href="<?php echo base_url('login')?>"><input type="submit" name="searchsubmit"></a>
			</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="section-title">
					<h2><?php echo $home_array["lg14_service_categories"]; ?></h2>
				</div>
				<?php $category = $this->data['category'];
					if($category) $length=count($category);
					else $length=0;
				?>
...
<div class="technicians-section">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="section-title">
					<h2><?php echo $home_array['lg14_service_provide']; ?></h2>
				</div>
						        ...
						        <div class="technician-widget">
									...
									<div class="right">
										<div class="inner-right">
											<h4><a href="<?php echo $base_url; ?>login"><?php echo ucfirst($provider['title']); ?></a></h4>
											...
											<div class="location-col d-flex justify-content-between mt-2">
												<div>
													<i class="fas fa-map-marker-alt"></i> <?php echo $provider['location']; ?>
												</div>
												<div>
													<div class="rating">
														<?php
				...
				<?php 
					...
					<div class="text-center w-100"><a href="javascript:void(0)" class="alter alter-danger" ><?php echo $home_array['lg14_no_details_were']; ?></a></div>
				<?php }
			?>
			</div>
			</div>
				...
				<div class="right">
					<?php if(!empty($how_title_img)) { ?>
						<div class="upload-images d-block">
							<img class="thumbnail" src="<?php echo base_url() . $how_title_img; ?>">
						</div>
					<?php } else { ?>
							<div class="upload-images d-block">
							<img class="thumbnail" src="<?php echo base_url() . 'assets/img/about-img.png'; ?>">
						</div>
					<?php } ?>
				</div>
			</div>
												...
												?>
													...
													<h6>
														...
														if($usercurrency_code){
															...
															echo strtoupper($currency_symbol.' '.$curr_amt);
														}else{
